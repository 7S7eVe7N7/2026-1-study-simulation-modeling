...
# ---- Анализ: поиск интенсивности с минимальным временем до пика ----
using Statistics
...
min_time = minimum(grouped.mean_peak_time)
opt_intensity = grouped.migration_intensity[argmin(grouped.mean_peak_time)]
println("Минимальное среднее время до пика: $min_time дней при интенсивности миграции = $opt_intensity")
